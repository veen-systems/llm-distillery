...
- **Nothing has taken effect yet** — a proposal, a draft law, a bill not yet enacted, a plan,
  a scheduled discussion, a proposed settlement, or preparations for an event. **Also:** a law
  or rule that has been passed but **is not yet in force** (it applies from a future date, even
  when the headline says it "now requires"); a **permit, permission or approval** for something
  not yet built or done; works, systems or facilities **"to be built"**, "set to open" or
  "planned"; a **petition, demand, appeal or campaign** for a change that has not happened.
  §1's rule that
