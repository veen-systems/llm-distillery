...
⛔ **AND THE RULE IS NOT ABOUT MONEY** *(owner ruling, 2026-09-03)*. A **proposal**, a **draft
law**, a **bill passed but not enacted**, a **plan**, a **scheduled discussion**, a **settlement
proposed** or **preparations** for an event are the same thing wearing different clothes:
**nothing has taken effect yet.** If the article's good news has not happened, score it as an
announcement, whatever it is about and however large it would be.

> **0-2:** *"Zelensky announces preparations for next prisoner exchange."* Preparations are not
> an exchange. Nobody has come home.
>
> **0-2:** *"Vietnam mulls scrapping death penalty for 6 offences."* Draft laws scheduled for
> discussion. **CONTRAST, scores normally:** *"Lebanon abolishes death penalty"* — enacted.
...
- A **policy change, review, apology or pledge made after the fact.** ⛔ **However much of
  the article it occupies, however well funded, however clearly caused by the events reported,
  and whether or not a commencement date has been set: a policy change that has NOT YET TAKEN
  EFFECT is an announcement.** *(Owner ruling, 2026-09-03. The former qualifier "especially as
  a trailing sentence" is RETIRED — it invited an exception for prominent, funded, dated
  regulation, which is exactly the shape this rule exists to catch.)*
...
- **Judicial relief whose only beneficiary is a person convicted of a violent offence** —
  early release, remission or a sentence reduction granted on age, good conduct or reformative
  grounds. The recipient is the offender; nobody harmed by the offence is better off, and a
  reader meets the article as its headline (§1). *(Owner ruling, 2026-09-03.)*
  ⚠️ **This does NOT touch §4's *amnesty delivered*.** Where the imprisonment ITSELF was the
  injustice — political prisoners freed, a wrongful conviction quashed, a dictatorship-era
  sentence voided — the release **is** the repair and scores normally. **The test is whether the
  conviction is the harm or the response to a harm.**
