...
# jeergrvgreg/human-thriving-filter-v9
...
| Metric | Value |
|--------|-------|
| Validation MAE | 0.5440 |
| Training MAE | 0.3747 |
| Validation RMSE | 0.8635 |
| Training RMSE | 0.5709 |

### Per-Dimension Performance (Validation MAE)

| Dimension | MAE |
|-----------|-----|
| Human Wellbeing Impact | 0.5384 |
| Social Cohesion Impact | 0.5148 |
| Justice Rights Impact | 0.4362 |
| Evidence Level | 0.6460 |
| Benefit Distribution | 0.5480 |
| Change Durability | 0.5807 |
...
repo_name = "jeergrvgreg/human-thriving-filter-v9"
...
- Validation MAE of 0.5440 indicates ~0.8 point average error on 0-10 scale
- Some overfitting observed (train/val gap: 0.17)
...
```bibtex
@misc{human_thriving_filter_v9_0,
  title={Human_Thriving Content Filter},
  author={Your Name},
  year={2026},
  url={https://huggingface.co/jeergrvgreg/human-thriving-filter-v9}
}
```
