"""
Human Thriving Filter v9 - HuggingFace Hub Inference
...
Usage:
    from filters.human_thriving.v9.inference_hub import HumanThrivingScorerHub

    scorer = HumanThrivingScorerHub(
        repo_id="jeergrvgreg/human-thriving-filter-v9",
...
class HumanThrivingScorerHub(BaseHumanThrivingScorer):
    ...
    def __init__(
        self,
        repo_id: str = "jeergrvgreg/human-thriving-filter-v9",
