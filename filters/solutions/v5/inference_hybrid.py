"""
Solutions Filter v5 — Hybrid Inference Pipeline
...
Usage:
    from filters.solutions.v5.inference_hybrid import SolutionsHybridScorer
...
from filters.solutions.v5.inference import SolutionsScorer
...
class SolutionsHybridScorer(HybridScorer):
    """
    Two-stage hybrid scorer for solutions filter v5.
    ...
    def _get_embedding_stage_config(self) -> Dict:
        """Return EmbeddingStage configuration for solutions v5."""
        return {
