"""
Solutions Filter v6 - Production Inference Pipeline
...
from filters.solutions.v6.base_scorer import BaseSolutionsScorer
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Score articles with the solutions filter v6")
