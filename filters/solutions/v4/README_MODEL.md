...
# jeergrvgreg/solutions-filter-v4
...
- **Training samples**: 9,265
- **Validation samples**: 1,032
...
| Metric | Value |
|--------|-------|
| Validation MAE | 0.5638 |
| Training MAE | 0.4928 |
| Validation RMSE | 1.1215 |
| Training RMSE | 0.9669 |

### Per-Dimension Performance (Validation MAE)

| Dimension | MAE |
|-----------|-----|
| Solution Concreteness | 0.7239 |
| Systemic Impact | 0.6531 |
| Evidence Strength | 0.6483 |
| Governance Intervention Strength | 0.5485 |
| Community Practice Strength | 0.2984 |
| Equity Access | 0.5521 |
| Economic Viability | 0.5225 |
...
repo_name = "jeergrvgreg/solutions-filter-v4"
...
- Validation MAE of 0.5638 indicates ~0.8 point average error on 0-10 scale
...
```bibtex
@misc{solutions_filter_v4_0,
  title={Solutions Content Filter},
  author={Your Name},
  year={2026},
  url={https://huggingface.co/jeergrvgreg/solutions-filter-v4}
}
```
