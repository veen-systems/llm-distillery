"""
Obituary Detector v3 - Embedding + MLP Classifier
...
Usage:
    from filters.common.obituary_detector.v3.inference import ObituaryDetectorV3

    detector = ObituaryDetectorV3(threshold=0.95)
    result = detector.is_obituary(article)
    # {"is_obituary": True, "score": 0.97, "version": "v3"}
"""
...
def is_obituary(article: Union[dict, str], threshold: float = 0.95) -> bool:
    ...
    """
    detector = ObituaryDetectorV3(threshold=threshold)
