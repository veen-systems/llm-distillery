# Gotcha log — archive (verbatim, entries dated before 2026-09-01)

*Moved out of `memory/gotcha-log.md` on 2026-09-24, **byte-for-byte and in original order** (#163, the
