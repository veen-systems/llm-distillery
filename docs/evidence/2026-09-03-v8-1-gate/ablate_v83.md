...
- **Nothing has taken effect yet** — a proposal, a draft law, a bill not yet enacted, a plan,
  ...
  *money committed is not a protection established* is not about money: if the article's good
  ...
  ⛔ **This is a category to EXCLUDE, not a test to apply.**
- **Judicial relief whose only beneficiary is a person convicted of a violent offence** —
  ...
  ⛔ **This bullet is an EXCLUSION and licenses nothing.** It simply does not reach the case
  where the imprisonment itself was the injustice — political prisoners, a wrongful conviction
  quashed. Those are governed by §4 exactly as before, neither widened nor narrowed here.
