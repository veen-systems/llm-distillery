...
law**, a **bill not yet enacted**, a **plan**, a **scheduled discussion**, a **proposed
settlement** or **preparations** for an event are the same thing wearing different clothes:
...
> discussion by a legislature.

⚠️ **This bullet only ADDS a way to score 0-2. It licenses nothing.** Do not read it as implying
that anything falling outside it scores normally: §1's occasion test and §2's *harm answered is
not harm undone* still apply in full, and a measure that HAS taken effect is still subject to
both.
