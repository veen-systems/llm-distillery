...
*Band audit RE-RUN: copied from the first run, with the 2026-09-25 rulings added and `cannot_judge` narrowed (ruling 5). Saved before the first batch ran. `{INPUT}` and `{OUTPUT}` are the batch's two file paths.*
...
1. Read the definition, in full, before any article:
   ...
   - `docs/decisions/2026-09-24-thriving-scope-rulings.md` and
     `docs/decisions/2026-09-25-thriving-scope-rulings.md` (the owner's rulings 1–5; they override
