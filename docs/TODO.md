...
- [x] **Universal obituary detector (#51)** — v3 shadow-deployed NM#185 (2026-07-27), v4 corrective retrain complete (2026-07-28). Op-point evidence 2026-07-30 (#83): v4 promoted at **0.90** not 0.95 (owner-flagged Farouq obituary scores 0.937 on v4; heldout FP set identical at both thresholds). NexusMind swap `02da4fe` auto-deploys next cycle, still shadow. Remaining (#83): FN-delta owner gate → sign-off → enforce → ovr#204.
