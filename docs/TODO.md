...
- [ ] **NexusMind `_assign_tier` double-cut (NM#280)** — **owner ADOPTED 2026-07-31** (visibility = raw ≥ op-point; normalized = rank/badge). Implement + ship AFTER the refits verify against correct-unit fits.
