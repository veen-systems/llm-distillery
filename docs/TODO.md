...
- [ ] **Fit the solutions short-content cap** (#93 step 4) — blocked on #92's second-op-point re-run. The mechanism is in place; the value is not justified. Do not set `short_content.cap` on any filter until an artifact-free estimate exists.
