...
- [x] **Universal obituary detector (#51)** — v3 shadow-deployed NM#185 (2026-07-27), v4 corrective retrain complete (2026-07-28). 12 hard negatives (8 ovr.news + 4 heldout FPs) all resolved. Heldout precision 0.977 @0.95. Waiting for ≥1 production cycle of shadow accumulation before v4 replace v3 → enforce. Then ovr#204 (remove hardcoded ovr.news obituary detection).
