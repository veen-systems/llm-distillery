...
- [ ] **Obituary v6 (#85)** — relabel corpus under the owner-adjudicated grief-vs-news rule (rewrite panel/relabel prompt first, owner reviews wording), retrain on b650 (env ready), golden set = the 14 adjudicated rows + ovr.news 203 + clean June holdout. Successor to v5@0.85 enforcement.
