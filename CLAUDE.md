...
| **human_thriving** | v8 | recall 0.314 / spec 0.9856 | **DEPLOYED + ENABLED 2026-09-07** (Hub, hybrid; PRs NM#452 then NM#453 — the package deploy did NOT enable it). Op-point 4.50. ✅ **Phase E FITTED 2026-09-22** on 2,976 rows, `raw_min == op_point` exactly (zero margin, strict `>`); #154 ruled + fixed. ⛔ **The defect is the PROMPT, not the student** — live audit `EXP-029`, #153. ⚠️ `uplifting v7` STILL LIVE; the cutover is a measured **7× cut** (`EXP-030`, #151): `memory/filter-status.md` |
