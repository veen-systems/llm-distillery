...
- **Before using any source as evidence, establish what it EXCLUDES.** *(11th
  occurrence 2026-08-27 — a `git archive HEAD` baseline tree, which ships tracked files
