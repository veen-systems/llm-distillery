...
| **human_thriving** | v8 | recall 0.314 / spec 0.9856 | **DEPLOYED + ENABLED 2026-09-07** (Hub, hybrid; PRs NM#452 then NM#453 — the package deploy did NOT enable it). Op-point 4.50. ⛔ **Phase E NOT fitted**; ⛔ **first cycle unconfirmed** — check `data/filtered/human_thriving/`. ⚠️ `uplifting v7` STILL LIVE, cutover #151: `memory/filter-status.md` |
