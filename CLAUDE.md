...
| **human_thriving** | v8 | recall 0.314 / spec 0.9856 | **LIVE 2026-09-07** (Hub, hybrid). Op-point 4.50 calibrated. ⛔ **Phase E normalization NOT fitted** — `normalization_method: none` until ≥200 production rows sit above 4.5. ⚠️ **`uplifting v7` is STILL LIVE too**; which one feeds the Thriving tab is an open owner decision: `memory/filter-status.md` |
