...
| **human_thriving** | v8 | recall 0.314 / spec 0.9856 | **DEPLOYED + ENABLED 2026-09-07** (Hub, hybrid; PRs NM#452 then NM#453 — the package deploy did NOT enable it). Op-point 4.50. ✅ Scoring confirmed; Phase E **168/200 cumulative**, don't disable. ⛔ **The defect is the PROMPT, not the student** — live audit `EXP-029`, #153. ⚠️ `uplifting v7` STILL LIVE, cutover #151: `memory/filter-status.md` |
