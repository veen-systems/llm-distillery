...
| **human_thriving** | v8 | recall 0.314 / spec 0.9856 | **DEPLOYED + ENABLED 2026-09-07** (Hub, hybrid; PRs NM#452 then NM#453 — the package deploy did NOT enable it). Op-point 4.50. ✅ Scoring confirmed; Phase E rows ARRIVED (**202/200**) — the fit is blocked by our own guard, #154; don't disable. ⛔ **The defect is the PROMPT, not the student** — live audit `EXP-029`, #153. ⚠️ `uplifting v7` STILL LIVE; the cutover is a measured **7× cut** (`EXP-030`, #151): `memory/filter-status.md` |
